...
double *io_png_read_flt_opt(const char *fname, size_t *nxp, size_t *nyp, size_t *ncp, io_png_opt_t opt);
double *io_png_read_flt(const char *fname, size_t *nxp, size_t *nyp, size_t *ncp);
...
void io_png_write_flt(const char *fname, const double *data, size_t nx, size_t ny, size_t nc);
